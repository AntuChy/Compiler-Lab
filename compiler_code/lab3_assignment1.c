...
void main(){
	...
	LL1 * table_LL1 = NULL;
	printf(">>> S' represented by P <<<\n");
	printf(">>> N(epsilon) Represented by & <<<\n");
	printf("Before Representation: S->iCtSS', S'->eS|N\n\n");

	printf(">>>   Enter .(dot) when finish to write grammar   <<<\n");
	printf("enter your after representation grammar : \n");
	saisie(&prod);
	printf("\n");
	printRules(prod);
